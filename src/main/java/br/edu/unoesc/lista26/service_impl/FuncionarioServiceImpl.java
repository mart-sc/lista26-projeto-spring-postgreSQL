package br.edu.unoesc.lista26.service_impl;
...
import br.edu.unoesc.lista26.dto.FuncionarioDTO;
import br.edu.unoesc.lista26.model.Funcionario;
import br.edu.unoesc.lista26.repository.FuncionarioRepository;
import br.edu.unoesc.lista26.service.FuncionarioService;
...
public class FuncionarioServiceImpl implements FuncionarioService {
	...
	public void popularTabelaInicial() {
		repositorio.saveAll(List.of(
				...
				new Funcionario(null, "Alex Martini",0, new BigDecimal("79.00"), LocalDate.of(2003, 9, 7))
			)
		);
	}
		...
		var l = repositorio.findById(id)
						   .orElseThrow(
								   () -> new ObjectNotFoundException("Funcionário não encontrado! Id: " +
										   + id + ", Tipo: " + Funcionario.class.getName(), (Object) null)
						   );
